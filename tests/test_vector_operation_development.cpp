...
protected:
    ...
    const T S_data[9] = {0.602841238050233, 1.0739289161074699, 1.2614571800985452, 1.0739289161074699,
                         0.1098837545217537, 1.5173777268660207, 1.2614571800985452, 1.5173777268660207,
                         1.8825352218960931};
    ...
    const T Sb_data[9] = {0.2518778240713093, 0.5791395811055904, 0.6566999231869227, 0.5791395811055904,
                          0.12823124204359715, 1.2002220391070737, 0.6566999231869227, 1.2002220391070737,
                          1.2755595533645294};
};  /*UNQ_TC_TIC_01*/
...
protected:
    // Results
    const T S_out[9] = {0.0028389047223614573, 0.01272013603531725, 0.007288320572583365, 0.01272013603531725,
                        0.056994466733066865, 0.03265640738909512, 0.007288320572583365, 0.03265640738909512,
                        0.018711306635382945};
};  /*UNQ_TF_FTV_01*/
...
protected:
    ...
    const T S_out[9] = {0.0028389047223614573, 0.01272013603531725, 0.007288320572583365, 0.01272013603531725,
                        0.056994466733066865, 0.03265640738909512, 0.007288320572583365, 0.03265640738909512,
                        0.018711306635382945};
    const T Sb_out[9] = {0.0013049897874637013, 0.005847201383859798, 0.0033503005014804787, 0.005847201383859798,
                         0.02619925791899191, 0.015011521099085788, 0.0033503005014804787, 0.015011521099085788,
                         0.008601227042577571};
...
protected:
    ...
    const T S_out[9] = {0.0028389047223614573, 0.01272013603531725, 0.007288320572583365, 0.01272013603531725,
                        0.056994466733066865, 0.03265640738909512, 0.007288320572583365, 0.03265640738909512,
                        0.018711306635382945};
    const T Sb_out[9] = {0.040391722906905035, 0.09964085760427532, 0.08002225748556513, 0.09964085760427532,
                         0.0819984614001504, 0.14972674203301628, 0.08002225748556513, 0.14972674203301628,
                         0.14465924654529685};
...
protected:
    ...
    const T S_out[9] = {0.0028389047223614573, 0.01272013603531725, 0.007288320572583365, 0.01272013603531725,
                        0.056994466733066865, 0.03265640738909512, 0.007288320572583365, 0.03265640738909512,
                        0.018711306635382945};
    const T Sb_out[9] = {0.04169671269436873, 0.10548805898813512, 0.08337255798704561, 0.10548805898813512,
                         0.10819771931914231, 0.16473826313210208, 0.08337255798704561, 0.16473826313210208,
                         0.15326047358787442};
    const T ab_out = 0.142782050042545;
    const T xb_out[3] = {0.4689548341984216, 0.4381533423353795, 0.963125629082972};
};  /*UNQ_TF_FTV_01*/
